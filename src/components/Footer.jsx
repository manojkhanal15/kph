...
const services = [
  { name: 'Netflix',       logo: '/logos/netflix.png',  color: '#E50914' },
  { name: 'Spotify',       logo: 'https://cdn.worldvectorlogo.com/logos/spotify-2.svg',  color: '#1DB954' },
  { name: 'ChatGPT Plus',  logo: 'https://cdn.worldvectorlogo.com/logos/chatgpt-6.svg',  color: '#10A37F' },
  { name: 'Canva Pro',     logo: '/logos/canva.png',    color: '#7D2AE7' },
  { name: 'MS Office 365', logo: '/logos/ms.png',   color: '#D83B01' },
  { name: 'NordVPN',       logo: '/logos/nord.png',  color: '#4687FF' },
  { name: 'Surfshark VPN',  logo: '/logos/surfshark.png',  color: '#4285F4' },
];
...
export default function Footer() {
  // Helper to convert link name to section id
      ...
      <div style={{
        ...
        <div>
          <a href="#home" style={{
            ...
            <div style={{
              ...
              <img
                ...
                onError={(e) => {
                  // Fallback: show text instead of broken image
                  e.currentTarget.style.display = 'none';
                  const parent = e.currentTarget.parentNode;
                  parent.style.background = 'rgba(255,215,0,0.2)';
                  parent.innerHTML = '<span style="font-size:20px;font-weight:900;color:#FFD700">K</span>';
                }}
              />
            </div>
            <div>
              <div style={{ fontSize: '15px', fontWeight: 700, color: '#e8e8f0' }}>
                Kantipur Premium
              </div>
              <div style={{ fontSize: '10px', color: '#FFD700', letterSpacing: '2px' }}>
                HUB
              </div>
            </div>
          </a>
          ...
          <p style={{
            ...
            marginBottom: '20px', lineHeight: 1.7, maxWidth: '260px',
          }}>
              ...
              <li key={service.name}>
                ...
                >
                  <span style={{
                    ...
                    flexShrink: 0,
                    padding: '3px',
                    boxShadow: `0 2px 8px ${service.color}44`,
                  }}>
                    <img
                      src={service.logo}
                      alt={service.name}
                      ...
                      onError={e => {
                        // Fallback: change background to brand color and hide broken image
                        const parent = e.currentTarget.parentNode;
                        parent.style.background = service.color;
                        parent.style.padding = '0';
                        parent.style.display = 'flex';
                        parent.style.alignItems = 'center';
                        parent.style.justifyContent = 'center';
                        e.currentTarget.style.display = 'none';
                        // Add first letter as text fallback
                        const span = document.createElement('span');
                        span.textContent = service.name.charAt(0);
